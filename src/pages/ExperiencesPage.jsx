        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {packages.map((pkg, index) => (
            <ScrollReveal key={pkg.id} delay={index * 0.1} width="100%">
              <div className="group relative rounded-3xl overflow-hidden glass-panel hover:bg-white/10 transition-all duration-500 flex flex-col border border-white/10 hover:border-primary/50 hover:shadow-[0_0_30px_rgba(234,179,8,0.15)]">
