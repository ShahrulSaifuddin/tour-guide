          ...
          <ScrollReveal delay={0.4}>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                ...
                specialize in crafting unforgettable journeys through the heart
                of Malaysia. My mission is to show you not just the sights, but
              ...
              <p>
                ...
                seeking adventure in the rainforest, I tailor each experience to
                your interests.
              </p>
              <p>
                I believe that travel is about connection. When you tour with
                me, you're not just visiting a destination; you're making a
                local friend who will ensure your safety, comfort, and enjoyment
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <ScrollReveal key={idx} delay={idx * 0.1}>
                <div className="bg-background p-8 rounded-xl shadow-lg border border-border/50 hover:border-primary/50 transition-colors h-full">
